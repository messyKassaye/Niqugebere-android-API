...
public class PullProductRecyclerviewAdapter extends RecyclerView.Adapter<PullProductRecyclerviewAdapter.MyViewHolder> {
    ...
    public PullProductRecyclerviewAdapter(Context mContext, List<ProductCategory> albumList, PullFragment fragments) {
