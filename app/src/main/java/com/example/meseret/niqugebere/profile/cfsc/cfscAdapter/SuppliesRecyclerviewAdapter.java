...
public class SuppliesRecyclerviewAdapter extends RecyclerView.Adapter<SuppliesRecyclerviewAdapter.MyViewHolder> {
    ...
    public SuppliesRecyclerviewAdapter(Context mContext, List<SuppliesAdapterModel> albumList) {
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.supply_layout, parent, false);
    ...
    public void onBindViewHolder(final MyViewHolder holder, int position) {
        ...
        dialog.setContentView(R.layout.apply_dialog_layout);
        ...
        holder.supply_type.setText("supply");
        ...
        apply_send.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String quantity=supply_quantity.getText().toString();
                if (quantity.equals("")){
                    ...
                    Call<ResponseToken>call=client.sendSupplyResult(getToken(),getSupplies_id(),quantity);
                    call.enqueue(new Callback<ResponseToken>() {
                        ...
                        public void onResponse(Call<ResponseToken> call, Response<ResponseToken> response) {
                            if (response.body().getStatus().equals("ok")){
                                ...
                                dialog.dismiss();
                                Toast.makeText(mContext,"Thank you for choosing us. We will deliver the product in a specified date ):",Toast.LENGTH_LONG).show();
                             }
                        }
