...
public class DemandProductRecyclerviewAdapter  extends RecyclerView.Adapter<DemandProductRecyclerviewAdapter.MyViewHolder> {
    ...
    public DemandProductRecyclerviewAdapter(Context mContext, List<ProductCategory> albumList, PostdDemandFragment fragments) {
