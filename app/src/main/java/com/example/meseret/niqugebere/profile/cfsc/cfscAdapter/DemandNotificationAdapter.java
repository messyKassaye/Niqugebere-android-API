...
public class DemandNotificationAdapter extends RecyclerView.Adapter<DemandNotificationAdapter.MyViewHolder> {
    ...
    public DemandNotificationAdapter(Context mContext, List<DemandsAdapterModel> albumList) {
