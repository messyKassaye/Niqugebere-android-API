...
public class PostInventorySubProductCategoryRecyclerviewAdapter extends RecyclerView.Adapter<PostInventorySubProductCategoryRecyclerviewAdapter.MyViewHolder> {
    ...
    public PostInventorySubProductCategoryRecyclerviewAdapter(Context mContext, List<ProductSubCategory> albumList, PostInventoryFragment fragments) {
