...
public class PushProductSubCategoryrecyclerviewAdapter extends RecyclerView.Adapter<PushProductSubCategoryrecyclerviewAdapter.MyViewHolder> {
    ...
    public PushProductSubCategoryrecyclerviewAdapter(Context mContext, List<ProductSubCategory> albumList, PushFragment fragments) {
