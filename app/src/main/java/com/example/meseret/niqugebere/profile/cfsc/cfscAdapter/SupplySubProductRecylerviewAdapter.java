...
public class SupplySubProductRecylerviewAdapter extends RecyclerView.Adapter<SupplySubProductRecylerviewAdapter.MyViewHolder> {

    private Context mContext;
    private List<ProductSubCategory> albumList;
    private boolean is_runnig=true;
    private PostSupplyFragment fragment;
    ...
    public SupplySubProductRecylerviewAdapter(Context mContext, List<ProductSubCategory> albumList, PostSupplyFragment fragments) {
