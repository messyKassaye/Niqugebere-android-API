...
public class SupplyProductrecyclerviewAdapter extends RecyclerView.Adapter<SupplyProductrecyclerviewAdapter.MyViewHolder> {
    ...
    public SupplyProductrecyclerviewAdapter(Context mContext, List<ProductCategory> albumList, PostSupplyFragment fragments) {
