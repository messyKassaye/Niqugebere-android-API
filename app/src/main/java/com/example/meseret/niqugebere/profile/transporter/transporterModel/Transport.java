...
public class Transport {
    ...
    public Transport(int id, String to_company, String to_woreda, String product_name, String product_sub_name, String title, String plate_no, String total_quantity) {
        this.id = id;
