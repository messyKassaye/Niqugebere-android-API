...
public class PushProductCategoryRecyclerviewAdapter extends RecyclerView.Adapter<PushProductCategoryRecyclerviewAdapter.MyViewHolder> {
    ...
    public PushProductCategoryRecyclerviewAdapter(Context mContext, List<ProductCategory> albumList, PushFragment fragments) {
