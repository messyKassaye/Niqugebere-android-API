...
import com.example.meseret.niqugebere.profile.cfsc.cfscAdapter.PostInventoryProductCatoryRecyclerviewAdapter;
import com.example.meseret.niqugebere.profile.cfsc.cfscAdapter.PostInventorySubProductCategoryRecyclerviewAdapter;
...
public class PostInventoryFragment extends Fragment {
    ...
    private PostInventoryProductCatoryRecyclerviewAdapter product_recyclerview_adapter;
    ...
    private PostInventorySubProductCategoryRecyclerviewAdapter product_subcategory_adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        pr=(ProgressBar)view.findViewById(R.id.inventory_pr);
        ...
        hiddenLayout=(LinearLayout)first_view.findViewById(R.id.invetoryHiddenLayout);



        product_category_list = new ArrayList<>();
        product_recyclerview_adapter = new PostInventoryProductCatoryRecyclerviewAdapter(getActivity(), product_category_list,this);
            ...
            public void onClick(View view) {
                ...
                if(getSub_category_id()==0){
                 ...
                 erro_shower.setText("Please enter product quantity");
                    ...
                    postInventory(String.valueOf(getSub_category_id()),String.valueOf(getSub_category_id()),product_name_value,product_quantity_value);
    ...
    public void displayProductSubCategory(String id,String product_name){
        ...
        product_subcategory_adapter=new PostInventorySubProductCategoryRecyclerviewAdapter(getActivity(),productSubCategoryList,this);
        ...
        call.enqueue(new Callback<List<MarketLists>>() {
            ...
            public void onResponse(Call<List<MarketLists>> call, Response<List<MarketLists>> response) {
                if(response.isSuccessful()){
                    ...
                    product_sub_category_textview.setText("Select what type of "+getProductName()+" you need to send as inventory");
