...
public class DemandSubProductrecylerviewAdapter extends RecyclerView.Adapter<DemandSubProductrecylerviewAdapter.MyViewHolder> {

    private Context mContext;
    private List<ProductSubCategory> albumList;
    private boolean is_runnig=true;
    private PostdDemandFragment fragment;
    ...
    public DemandSubProductrecylerviewAdapter(Context mContext, List<ProductSubCategory> albumList, PostdDemandFragment fragments) {
